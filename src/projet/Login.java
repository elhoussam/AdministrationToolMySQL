...
public class Login extends JDialog {
	...
	public Login(  JFrame fram ) {  
		...
		this.setIconImage(  (new ImageIcon( getClass().getResource("icons/icon_main.png") ) ).getImage()    );
		...
		log_head.setIcon( new ImageIcon( getClass().getResource("icons/login-header.png") ));
		panel_2.add(log_head);
		
		JLabel userLabel = new JLabel("");
		userLabel.setIcon( new ImageIcon( getClass().getResource("icons/Login_user.png") ) );
		userLabel.setBounds(93, 130, 30, 28);
		getContentPane().add(userLabel);
		
		JLabel passLabel = new JLabel("");
		passLabel.setIcon(new ImageIcon( getClass().getResource("icons/Login_lock.png")) );
