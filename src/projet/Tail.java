...
public class Tail extends JPanel{
  ...
  public Tail(){
    ...
    new ImageIcon( getClass().getResource("icons/tail_error.png") );
    new ImageIcon( getClass().getResource("icons/tail_sql.png") );
    new ImageIcon( getClass().getResource("icons/tail_inf.png") );
