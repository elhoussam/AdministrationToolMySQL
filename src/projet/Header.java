...
public class Header extends JPanel {
	...
	public Header(){  
		...
		img.setIcon(new ImageIcon( getClass().getResource("icons/sqlserver.png") ) );
		...
		// Creation pop menu  
		 final JPopupMenu popmenu = new JPopupMenu ();
			...
			JMenuItem conn = new JMenuItem(Lang.getWord("Connecter"),new ImageIcon( getClass().getResource("icons/head_Login.png") ));
			JMenuItem arbre = new JMenuItem(Lang.getWord("Afficher / Masquer Arbre") ,new ImageIcon( getClass().getResource("icons/head_Tree.png") ));
			JMenuItem option = new JMenuItem(Lang.getWord("Afficher / Masquer Option"),new ImageIcon( getClass().getResource("icons/head_hide.png") ));
			JMenuItem about = new JMenuItem(Lang.getWord("A propos"),new ImageIcon( getClass().getResource("icons/head_about.png") )); 
			JMenuItem aide = new JMenuItem(Lang.getWord("Aîde"),new ImageIcon( getClass().getResource("icons/head_aide.png") )); 
		 final JMenu theme = new JMenu(Lang.getWord("Théme"));
		 				theme.setIcon( new ImageIcon( getClass().getResource("icons/head_theme.png") ) );
		 ...
		 about.addActionListener( new ActionListener(){
	            ...
	            public void actionPerformed(ActionEvent e) {
			    		...
			    		abt.setLocation(x, y);
			 			...
			 			JLabel lab_img = new JLabel( new ImageIcon( getClass().getResource("icons/about_image.png") ) );
