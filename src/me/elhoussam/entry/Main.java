		...
		// init main frame 
		 Lang.InitLang();
						...
						JFrame aaaz = new JFrame( Lang.getWord("Outil Admin Sql Server 2014") );
							...
							URL str = getClass().getClassLoader().getResource("icons/icon_main.png") ;
							Main.echo("["+((str==null)?"@":str.toString())+"]");
				    		getPrinc().setIconImage( (new ImageIcon(  str )).getImage() );
