...
import me.elhoussam.db.DB_add;
import me.elhoussam.db.DB_mod;
import me.elhoussam.entry.Main;
import me.elhoussam.lng.Lang;
import me.elhoussam.lng.Lang_add;
import me.elhoussam.lng.Lang_del;
import me.elhoussam.lng.Lang_mod;
import me.elhoussam.log.LOG_add;
import me.elhoussam.log.LOG_del;
import me.elhoussam.log.LOG_mod;
import me.elhoussam.rl.ROL_add;
import me.elhoussam.rl.ROL_del;
import me.elhoussam.rl.ROL_mod;
import me.elhoussam.sch.SCH_add;
import me.elhoussam.sch.SCH_del;
import me.elhoussam.tbl.TBL_add;
import me.elhoussam.tbl.TBL_add_col;
import me.elhoussam.tbl.TBL_del_col;
import me.elhoussam.tbl.TBL_mod;
...
public class MENUU extends JPanel { 
	...
	static class option extends JPanel {
		...
		public option(String Op_name , ImageIcon img ) {
			...
			icon = new JLabel("");
			icon.setIcon( new ImageIcon( getClass().getClassLoader().getResource("icons/menu_close.png") )  );
			...
			Arrow.setIcon(new ImageIcon( getClass().getClassLoader().getResource("icons/arrow.png") ) );
	...
	public MENUU() {
			setLayout( new GridLayout(0, 1) );
				...
				final option db = new option( Lang.getWord("Base de donneé"), new ImageIcon( getClass().getClassLoader().getResource("icons/menu_database.png") ) );
				...
				option tb = new option( Lang.getWord("Table") , new ImageIcon( getClass().getClassLoader().getResource("icons/menu_table.png") ) );
				...
				option sch = new option( Lang.getWord("Schéma") , new ImageIcon( getClass().getClassLoader().getResource("icons/menu_schema.png") ) );
				...
				option log = new option(  Lang.getWord("Log in") ,new ImageIcon( getClass().getClassLoader().getResource("icons/menu_user.png") ) ) ;
				...
				option lng = new option( Lang.getWord("Langue"),new ImageIcon( getClass().getClassLoader().getResource("icons/menu_langue.png") ) ) ;
				...
				option rol = new option( Lang.getWord("Rôle") ,new ImageIcon( getClass().getClassLoader().getResource("icons/menu_user.png") ) ) ;
